...
export const THEMES: Record<TimeTheme['name'], TimeTheme> = {
  ...
  dawn: {
    ...
    textBody: '#f9eff5',
    textMuted: 'rgba(249,239,245,0.72)',
    accent: '#EA526F',
  ...
  sunrise: {
    ...
    textBody: '#f5eef2',
    textMuted: 'rgba(245,238,242,0.72)',
    accent: '#EA526F',
  ...
  dusk: {
    ...
    textBody: '#f5ece0',
    textMuted: 'rgba(245,236,224,0.72)',
    accent: '#EA526F',
  ...
  sunset: {
    ...
    textBody: '#f2f2fa',
    textMuted: 'rgba(242,242,250,0.72)',
    accent: '#EA526F',
    divider: 'rgba(255,255,255,0.08)',
  },
}
