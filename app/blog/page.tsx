              ...
              >
                ...
                {article.image && (
                  <div
                    ...
                    style={{ width: '160px', height: '120px', borderRadius: '12px', overflow: 'hidden', flexShrink: 0, alignSelf: 'center' }}
                  >
                    <img
                      src={urlFor(article.image).width(320).height(240).fit('crop').url()}
                      alt={article.title}
